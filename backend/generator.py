...
SYSTEM_PROMPT = (
    ...
    "At the very end of EVERY answer, on its own line, append exactly this (and nothing after it): "
    "|||SUGGEST: <q1> | <q2> | <q3> — where q1-q3 are three short follow-up questions a student would "
    "naturally ask next, grounded in the current topic and answerable from the department website. "

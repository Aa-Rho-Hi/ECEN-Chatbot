...
SYSTEM_PROMPT = (
    ...
    "At the very end of EVERY answer, on its own line, append the |||SUGGEST marker followed by three "
    "plain-text follow-up questions separated by |. Write the questions as plain text with NO angle brackets, "
